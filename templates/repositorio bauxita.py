...
# ----------------------------
    ...
    #return Response(salida_flask, mimetype='text/plain')

    return render_template("bauxita.html",plantas_abiertas=plantas_abiertas,costo_total_minimo=costo_total_minimo) # para mostrar en la pagina web al usuario 
